                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DropdownButton<int>(
                          ...
                          items: generateSectorList(listInformation[0]).map((int value) {
                          ...
                          onChanged: (value) {
                            setState(() {
                              _selectedSector = value ?? 0;
                              _selectedBlock = generateBlockList(_selectedSector, listInformation[1])[0];
                            });
                          },
                        ),
                        Text('Block'),
                        DropdownButton<int>(
                          ...
                          items: generateBlockList(_selectedSector, listInformation[1]).map((int value) {
                            return DropdownMenuItem<int>(
                              value: value,
                              child: Text(value.toString()),
                            );
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () async {
                            ...
                            await showToast(message: '${message[0]}\n${message[1]}\n${message[2]}\n${message[3]}');
                          },
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: () async => showToast(message: (await MifareNfcClassic.blockCount).toString()),
                          child: Text('Get Block Count'),
                        ),
                        TextButton(
                          onPressed: () async => showToast(message: (await MifareNfcClassic.sectorCount).toString()),
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        if (_selectedSector == 0 || (_selectedBlock + 1) % 4 == 0) {
                          showToast(message: "Don't Write in this sector or block");
                        } else if (message!.isEmpty) {
                          showToast(message: "Write Something");
                        } else {
                          await MifareNfcClassic.writeBlock(blockIndex: _selectedBlock, message: message!);
                        }
                      },
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        if (message!.isEmpty) {
                          ...
                          await MifareNfcClassic.writeRawHexToBlock(blockIndex: _selectedBlock, message: message!);
                        }
                      },
